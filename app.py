...
CONSTANT_PARAM_LABELS = {
    "C": "C_i — цена закупки", "H": "H_i — затраты хранения", "S": "S_i — оформление заказа",
    "T": "T_i — транспортные расходы", "P": "P_i — вероятность задержки", "R": "R_i — надежность поставщика",
    "K": "K_i — качество поставки", "D": "D_i — спрос", "D_fuzzy_min": "D_i min — нечеткий спрос",
    "D_fuzzy_max": "D_i max — нечеткий спрос", "L": "L_i — срок поставки", "L_fuzzy_min": "L_i min — нечеткий срок",
    "L_fuzzy_max": "L_i max — нечеткий срок", "W_i": "W_i — вместимость склада", "V": "V_i — потери от дефицита",
    "E": "E_i — эксплуатационные затраты", "Z": "Z_i — риск поставщика", "d_dist": "d_i — расстояние доставки",
    "T_max": "T_max — макс. транспортные затраты", "A": "A_i — стоимость/км", "G": "G_i — погрузка-разгрузка",
    "Fi_cost": "Fi_i — оборудование", "Y_prod": "Y_i — производительность склада", "Y_min": "Y_min — мин. производительность",
...
with st.sidebar:
    ...
    # ВОТ ЗДЕСЬ ТЕПЕРЬ ПОСТОЯННЫЕ ПАРАМЕТРЫ (КОНСТАНТЫ)
...
st.write("### 🎛️ Переменные параметры (Ввод ограничений)")
